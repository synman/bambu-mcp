...
```
~/bambu-mcp/
├── server.py                    ← FastMCP entry point (73 tools, 9 resources, 1 prompt)
...
│   ├── print_control.py         ← 6 print control tools
│   ├── climate.py               ← 6 climate tools
│   ├── filament.py              ← 9 filament/AMS tools
│   ├── nozzle.py                ← 3 nozzle config tools
│   ├── detectors.py             ← 5 detector tools
│   ├── management.py            ← 5 printer lifecycle tools
│   ├── files.py                 ← 10 file operation tools
│   ├── system.py                ← 8 system/session tools
