...
_RESOURCES = [
    ...
    ("bambu://knowledge/behavioral-rules/session",      get_behavioral_rules_session,      "Session management: printer name verification, post-reload checklist"),
